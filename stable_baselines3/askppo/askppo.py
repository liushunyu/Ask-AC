...
class AskPPO(OnAskPolicyAlgorithm):
    """
    Ask Proximal Policy Optimization algorithm (Ask PPO) (clip version)
    ...
    def _setup_model(self) -> None:
        super(AskPPO, self)._setup_model()
            ...
            for epoch in range(self.n_epochs):
                for rollout_data in self.rollout_buffer.get(self.batch_size):
                    ...
                    if ask_observations_num > 0:
                        al_coef = al_coef * ask_observations_num / self.batch_size
        ...
        for epoch in range(self.n_epochs):
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if human_actions_num > 0:
                    hl_coef = hl_coef * human_actions_num / self.batch_size
    ...
    def learn(
        ...
        tb_log_name: str = "AskPPO",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "AskPPO":

        return super(AskPPO, self).learn(
